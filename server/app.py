...
"""
FastAPI application for the Pii Redaction V1 Environment.

This module creates an HTTP server that exposes the PiiRedactionV1Environment
...
try:
    ...
    from models import PiiRedactionV1Action, PiiRedactionV1Observation
    from server.pii_redaction_v1_environment import PiiRedactionV1Environment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m pii_redaction_v1.server.app
    ...
    multiple workers:
        uvicorn pii_redaction_v1.server.app:app --workers 4
    """
    import uvicorn
